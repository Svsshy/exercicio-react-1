        ...
        <div className="inputs">
          ...
          <div className="inputContainer">
            <div className="inputWrapper">
              ...
              <input placeholder="Título" type="text" onChange={handleOnChangeTitle}/>
            </div>
            <div className="inputWrapper">
...
" type="textarea" onChange={handleOnChangeText}/>
            </div>
          </div>
        </div>
        <div className="preview">
          ...
          <div className="previewContainer">
            <h1>{titleState}</h1>
            <div className="previewText">{textState}</div>
          </div>
        </div>
